...
<script>
import QuestionnaireHeader from "../components/Questionnaire/SubClubSelectionHeader.vue";       
export default {
    
    name:"QuestionnaireResult",
    components : {
            "questionnaire-header" : QuestionnaireHeader
        },
    data(){
...
.grid-container > div.sub-club-section {
